...
questions:
  ...
  - q: |
      ...
      // What does 'satisfies' do differently than a type annotation?
    options:
  ...
  - q: |
      ...
      // Why is the first approach preferred?
    options:
  ...
  - q: |
      ...
      // What does Getters<{ name: string }> produce?
    options:
      - text: "{ name: string }"
        correct: false
      - text: "{ getName: () => string }"
